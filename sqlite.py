class SQLite():
    ...
    def get_elemento_tabla(self, nombre_tabla, id, elemento):
        '''obtiene un elemento específico de stock en base a su referencia'''
        if nombre_tabla == "stock":
    ...
    def editar_from_stock(self, nombre_tabla, id, columna1=None, columna2=None, columna3=None, elemento1=None, elemento2=None, elemento3=None):
        '''editar nombre, categoria y/o stock_mín desde el frame stock'''
    ...
    def editar_from_historial(self, id, datos):
        '''edita proveedor precio descuento y total de historial'''
        self.cursor.execute("UPDATE historial SET proveedor=?, precio_unidad=?, descuento=?, total=? WHERE fecha=?", datos + (id,))
        self.con.commit()


    def existe(self, nombre_tabla, columna, elemento):
        '''comprueba la existencia de un elemento concreto en una tabla concreta'''
    ...
    def set_valor_producto(self, nombre_tabla, columna, id, valor):
        '''cambia el valor de un único parámetro de un producto concreto en base a su id'''
        if nombre_tabla == "stock":
    ...
    def filtrar(self, nombre_tabla, columna1, criterio1, columna2=None, criterio2=None, columna3=None, criterio3=None):
        '''selecciona los productos/compras que cumplan con X criterios'''
